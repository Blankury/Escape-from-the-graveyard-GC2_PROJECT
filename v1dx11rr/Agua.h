...
public:
	AguaRR(WCHAR* billb, WCHAR* normal, WCHAR* disp, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, float escala)
	{
	...
	bool CargaParametros(WCHAR* billb, WCHAR* normal, WCHAR* disp, float escala)
	{
		...
		bool compileResult = CompileD3DShader(L"Awa.hlsl", "VS_Main", "vs_4_0", &vsBuffer);
		...
		compileResult = CompileD3DShader(L"Awa.hlsl", "PS_Main", "ps_4_0", &psBuffer);
